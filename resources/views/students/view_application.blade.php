   ...
   <form method="POST" action="{{route("$section.verifyApplicationStatus")}}">
       ...
       <input type="hidden" name="id" value="{{$registration->id}}" />
        <div>
            ...
            <x-text-input id="res_no" class="block mt-1 w-full" type="text" name="res_no" value="{{$registration->res_no}}"  disabled/>
        </div>
        ...
        <div>
            ...
            <x-text-input id="percentage" class="block mt-1 w-full" type="text" name="percentage" value="{{$registration->percentage}} %"  disabled/>
        </div>
