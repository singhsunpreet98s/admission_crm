   ...
   <nav aria-label="breadcrumb">
     <ul class="breadcrumb">
       <li class="breadcrumb-item active" aria-current="page">
        <a href="javascript:;" class="btn btn-secondary btn-icon-text" data-modal="{{$section}}_create" data-url="{{route("admin.$section.create")}}" > <i class="mdi mdi-account-plus-outline btn-icon-prepend"></i> Add Course </a>
       </li>
     </ul>
   </nav>
 </div>
